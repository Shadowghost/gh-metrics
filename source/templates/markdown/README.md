...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="https://github.com/Shadowghost/gh-metrics/blob/examples/metrics.markdown.png" alt=""></img>
...
Use `config_output: json` to dump all available data for a given configuration. Power users can also directly read [metrics source code](https://github.com/Shadowghost/gh-metrics) to know what is exposed.
...
<img src="https://github.com/Shadowghost/gh-metrics/blob/examples/.cache/example-languages-pdf.svg">
...
with:
  ...
  markdown: >-
    https://raw.githubusercontent.com/Shadowghost/gh-metrics/examples/metrics.markdown.template.md
...
with:
  ...
  markdown: >-
    https://raw.githubusercontent.com/Shadowghost/gh-metrics/master/source/templates/markdown/example.md
  config_output: markdown
  plugin_activity: yes
...
with:
  ...
  markdown: >-
    https://raw.githubusercontent.com/Shadowghost/gh-metrics/master/source/templates/markdown/example.pdf.md
