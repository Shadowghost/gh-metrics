...
All product and company names are trademarks™ or registered® trademarks of their respective holders.</p>
  ...
  <tr>
    <td colspan="2" align="center">
      <details open><summary>Related to a user</summary><img src="https://github.com/Shadowghost/gh-metrics/blob/examples/metrics.plugin.people.followers.svg" alt=""></img></details>
      <details><summary>Related to a repository</summary><img src="https://github.com/Shadowghost/gh-metrics/blob/examples/metrics.plugin.people.repository.svg" alt=""></img></details>
